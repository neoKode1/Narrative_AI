...
export class RunwayML extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('RUNWAYML_BASE_URL'), apiKey = Core.readEnv('RUNWAYML_API_SECRET'), runwayVersion = '2024-09-13', ...opts } = {}) {
        if (apiKey === undefined) {
...
export const { RunwayMLError, APIError, APIConnectionError, APIConnectionTimeoutError, APIUserAbortError, NotFoundError, ConflictError, RateLimitError, BadRequestError, AuthenticationError, InternalServerError, PermissionDeniedError, UnprocessableEntityError, } = Errors;
export var toFile = Uploads.toFile;
export var fileFromPath = Uploads.fileFromPath;
(function (RunwayML) {
    RunwayML.Tasks = API.Tasks;
    RunwayML.ImageToVideo = API.ImageToVideo;
})(RunwayML || (RunwayML = {}));
