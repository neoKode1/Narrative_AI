...
import * as ImageToVideoAPI from "./image-to-video.js";
export declare class ImageToVideo extends APIResource {
     ...
     */
    create(body: ImageToVideoCreateParams, options?: Core.RequestOptions): Core.APIPromise<ImageToVideoCreateResponse>;
}
